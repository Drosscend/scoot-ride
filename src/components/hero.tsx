...
export function Hero() {
  return (
    <section className="bg-primary flex min-h-screen items-center text-white">
      <div className="container mx-auto px-6 text-center">
        <h1 className="mb-4 text-4xl font-bold md:text-6xl">{`La mobilité Durable en Zone Rurale`}</h1>
